...
import { addToWatchList, createAuction, deleteAuction, deleteAuctionFromWatchList, getAuctionByCategory, getAuctionByFilters, getAuctionById, getHomeAuctions, getUserAuctions, getWatchList, updateAuction } from "../controllers/auction.controller";
...
router.delete('/watchlist', authenticateToken(), deleteAuctionFromWatchList)
